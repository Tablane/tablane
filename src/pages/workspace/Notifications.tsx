                            ...
                            content: [
                                {
                                    ...
                                    content: [
                                        ...
                                        {
                                            type: 'text',
                                            text: ' in a product should be based on a thorough analysis of the '
                                        },
                                        {
                                            type: 'text',
                                            marks: [
                                        ...
                                        {
                                            type: 'text',
                                            text: ' can greatly enhance product functionality and user experience, but it also requires significant resources and expertise to develop and maintain. Ultimately, the decision to use AI should be based on a clear understanding of the product goals and user needs.'
                                        }
                                    ]
                                }
                            ]
