...
function TaskColumnPopover({
    ...
    return (
        <Menu as="div" className="relative">
            ...
            >
                <Menu.Items className="z-[60] absolute right-[-10px] mt-2 w-[140px] origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none bg-[C4C4C4FF]">
