...
import General from "./partials/settings/workspace/General";
import Import from "./partials/settings/workspace/Import";
import Apps from "./partials/settings/workspace/Apps";
import Billing from "./partials/settings/workspace/Billing";
import Trash from "./partials/settings/workspace/Trash";
